...
JPushPlugin.prototype.receiveMessageInAndroidCallback = function(data){
	try{
		...
		cordova.fireDocumentEvent('plugin.receiveMessage',null);
		//console.log(data);
		//var message  = bToObj.message;
		//var extras  = bToObj.extras;

		//console.log(message);
		//console.log(extras['cn.plugin.android.MSG_ID']);
		//console.log(extras['cn.plugin.android.CONTENT_TYPE']);
		//console.log(extras['cn.plugin.android.EXTRA']);
	}
	catch(exception){               
...
JPushPlugin.prototype.openNotificationInAndroidCallback = function(data){
	try{
		...
		cordova.fireDocumentEvent('plugin.openNotification',null);
		...
		//console.log(extras['cn.plugin.android.NOTIFICATION_CONTENT_TITLE']);
		//console.log(extras['cn.plugin.android.EXTRA']);
		//console.log(extras['cn.plugin.android.PUSH_ID']);
		//console.log(extras['cn.plugin.android.NOTIFICATION_ID']);
...
JPushPlugin.prototype.receiveNotificationInAndroidCallback = function(data){
	try{
		...
		cordova.fireDocumentEvent('plugin.receiveNotification',null);
